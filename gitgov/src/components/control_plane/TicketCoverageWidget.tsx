  ...
  return (
    <div className="glass-panel p-5 flex flex-col">
      ...
      <div className="flex gap-1.5 mb-2">
        <input value={ticketRepoFilter} onChange={(e) => setTicketRepoFilter(e.target.value)} placeholder="repo" className="flex-1 min-w-0 rounded-lg bg-white/3 border border-white/6 px-2 py-1.5 text-[10px] text-white placeholder:text-surface-600 focus:border-brand-500/40 focus:outline-none transition-colors" />
        <input value={ticketBranchFilter} onChange={(e) => setTicketBranchFilter(e.target.value)} placeholder="rama" className="flex-1 min-w-0 rounded-lg bg-white/3 border border-white/6 px-2 py-1.5 text-[10px] text-white placeholder:text-surface-600 focus:border-brand-500/40 focus:outline-none transition-colors" />
        <select value={ticketHours} onChange={(e) => setTicketHours(Number(e.target.value))} className="w-14 shrink-0 rounded-lg bg-white/3 border border-white/6 px-1 py-1.5 text-[10px] text-white focus:border-brand-500/40 focus:outline-none transition-colors">
